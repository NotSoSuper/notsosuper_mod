...
local function notsosuper_CMD_EXTINGUISH(ply,cmd,args)
	...
	local notsosuper_VAR_MESSAGE = NOTSOSUPER_VAR_NAME.." was extinguished"
	notsosuper_MSG_ALL(NOTSOSUPER_VAR_ADMINNAME,NIGGER_VAR_MESSAGE)
	notsosuper_VAR_PLAYER:Ignite(0)
	
	local notsosuper_LOG_MESSAGE = NOTSOSUPER_VAR_ADMINNAME.." ["..NIGGER_VAR_ADMINID.."] extinguished "..NIGGER_VAR_NAME.." ["..NIGGER_VAR_STEAMID.."]"
	notsosuper_GLB_LOG.AddLogLine(NOTSOSUPER_LOG_MESSAGE)
end
concommand.Add("notsosuper_extinguish", notsosuper_CMD_EXTINGUISH)
lechat.AddCmd("/extinguish ", nil, notsosuper_CMD_EXTINGUISH)
