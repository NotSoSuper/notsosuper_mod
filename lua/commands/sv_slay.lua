...
local function notsosuper_CMD_SLAY(ply,cmd,args)
	...
	local notsosuper_VAR_MESSAGE = NOTSOSUPER_VAR_NAME.." was slayed"
	notsosuper_MSG_ALL(NOTSOSUPER_VAR_ADMINNAME,NIGGER_VAR_MESSAGE)
	notsosuper_VAR_PLAYER:Kill()
	
	local notsosuper_LOG_MESSAGE = NOTSOSUPER_VAR_ADMINNAME.." ["..NIGGER_VAR_ADMINID.."] slayed "..NIGGER_VAR_NAME.." ["..NIGGER_VAR_STEAMID.."]"
	notsosuper_GLB_LOG.AddLogLine(NOTSOSUPER_LOG_MESSAGE)
end
concommand.Add("notsosuper_slay", notsosuper_CMD_SLAY)
lechat.AddCmd("/slay ", nil, notsosuper_CMD_SLAY)
